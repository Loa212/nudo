...
async fn every_form_the_dashboard_renders_posts_to_a_route_that_exists() {
    ...
    let actions = [
        ...
        "/targets/tgt_1/ingress/enable",
        "/targets/tgt_1/ingress/disable",
        "/targets/tgt_1/ingress/reload",
        "/build-hosts",
        "/build-hosts/default",
...
fn no_form_action_in_the_renderer_is_missing_from_that_list() {
    ...
    let covered = [
        ...
        "/targets/{}/ingress/enable",
        "/targets/{}/ingress/disable",
        "/targets/{}/ingress/reload",
        "/build-hosts",
        "/build-hosts/default",
        "/build-hosts/{}/check",
